package org.superpranx.aoc2024.day07;
...
public class Day07TaskTest extends TestCase {
  ...
  public void testPartOne() {
    BigInteger result = Day07Task.partOne(Day07Task.extractListsFromInputFile("aoc-2024/day07/input.txt"));
  ...
  public void testPartTwo() {
    ...
    BigInteger result = Day07Task.partTwo(Day07Task.extractListsFromInputFile("aoc-2024/day07/input.txt"));
    stopWatch.stop();
    System.out.println("Result: " + result);
